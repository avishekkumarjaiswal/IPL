    ...
    if not active_item:
        ...
        with cols[3]:
            ...
            for item_name, team_bought, sold_amount in sold_to_show:
                # Truncate item name to a maximum of 11 characters, ensuring at least 10 characters are visible
                if len(item_name) > 11:
                    truncated_item_name = item_name[:11] + ' '
                else:
                    truncated_item_name = item_name  # Show the full name if it's 11 characters or less
